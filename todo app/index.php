...
<body class="min-h-100vh grid place-content-center justify-center">
    ...
    <form action="/todo app/createTodo.php" method="post" hx-boost="true" hx-target="#notCompleted" hx-push-url="false">
    ...
    <div id="notCompleted">
        <form id="notCompletedForm" action="/todo app/toggleTodo.php" method="post" hx-boost="true" hx-push-url="false" hx-target="#completedForm" hx-trigger="change">
